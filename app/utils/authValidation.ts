...
const FALLBACK_AUTH_RULES: AuthValidationRules = {
  username: {
    ...
    hint: "Username must be 1-16 characters and use only A-Z, a-z and 0-9.",
  },
  password: {
    minLength: 8,
    maxLength: 32,
    ...
    hint: "Password must be 8-32 characters, include at least one uppercase letter and one special symbol and use only A-Z, a-z, 0-9 and !\"#$%&'()*+,-./:;<=>?@[\\\\]^_`{|}~.",
